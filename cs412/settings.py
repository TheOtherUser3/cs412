...
# Description: Settings file for all cs412 applications
"""
...
SECRET_KEY = "django-insecure-)6h*jzfsskhzst8t6(wbzf5isi#i*i*^cj^16!ok64^eluqtt1"
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            "string_if_invalid": "WARNING: {{%s}} IS INVALID CONTEXT VARIABLE",
            "context_processors": [
...
MEDIA_URL = "media/"
CS_DEPLOYMENT_HOTNAME = 'cs-webapps.bu.edu'
